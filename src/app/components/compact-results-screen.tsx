...
export function CompactResultsScreen({
  guessHistory,
  stage1Mistakes,
  stage2Mistakes,
  totalLives,
  ...
  // Get only solved rows for compact share format
  ...
  // Compact share text - only solved rows with emojis
  const buildShareText = (): string => {
    ...
    if (reachedLinkPhase && relinkAttempts.length > 0) {
      lines.push("➖➖➖➖");
        ...
        <div className="flex flex-col gap-[24px] items-center w-full">
          ...
          >
            <div className="flex flex-col gap-[16px] items-center p-[32px]">
              ...
              {/* Results visual card — compact display with colored squares */}
