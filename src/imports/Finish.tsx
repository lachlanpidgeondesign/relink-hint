import svgPaths from "./svg-e5cte450iy";
...
function IcoTickCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="ico-tick-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ico-tick-circle">
          <g clipPath="url(#clip0_2_948)">
            <rect fill="var(--fill-0, white)" height="20" rx="10" width="20" />
            <path d={svgPaths.p1b300280} fill="var(--fill-0, black)" id="Vector" />
          </g>
        </g>
        <defs>
...
function LinkContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-black text-center text-ellipsis">WET WEATHER</p>
      <IcoTickCircle />
    </div>
  );
}
...
function WordContainer1() {
  return (
    <div className="bg-[#f8cd8b] col-1 content-stretch flex flex-col gap-[8px] h-[80.5px] items-center justify-center overflow-clip p-[8px] relative rounded-[8px] row-1 shrink-0 w-[358px]" data-name="Word Container">
      <LinkContainer />
...
function LinkContainer1() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-black text-center text-ellipsis">KEYBOARD KEYS</p>
      <IcoTickCircle1 />
    </div>
  );
}
...
function WordContainer2() {
  return (
    <div className="bg-[#66e0c4] col-1 content-stretch flex flex-col gap-[8px] h-[80.5px] items-center justify-center overflow-clip p-[8px] relative rounded-[8px] row-2 shrink-0 w-[358px]" data-name="Word Container">
      <LinkContainer1 />
...
function IcoXmarkCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="ico-xmark-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ico-xmark-circle">
          <g clipPath="url(#clip0_2_945)">
            <rect fill="var(--fill-0, white)" height="20" rx="10" width="20" />
            <path d={svgPaths.p23f4cbf0} fill="var(--fill-0, black)" id="Vector" />
          </g>
        </g>
        <defs>
...
function LinkContainer2() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-black text-center text-ellipsis">NBA TEAMS</p>
      <IcoXmarkCircle />
    </div>
  );
}
...
function WordContainer3() {
  return (
    <div className="bg-[#87d1dc] col-1 content-stretch flex flex-col gap-[8px] h-[80.5px] items-center justify-center overflow-clip p-[8px] relative rounded-[8px] row-3 shrink-0 w-[358px]" data-name="Word Container">
      <LinkContainer2 />
...
function LinkContainer3() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-black text-center text-ellipsis">PALINDROMES</p>
      <IcoTickCircle2 />
    </div>
  );
}
...
function WordContainer4() {
  return (
    <div className="bg-[#9aa3ff] col-1 content-stretch flex flex-col gap-[8px] h-[80.5px] items-center justify-center overflow-clip p-[8px] relative rounded-[8px] row-4 shrink-0 w-[358px]" data-name="Word Container">
      <LinkContainer3 />
    ...
    <div className="h-[12px] relative shrink-0 w-[66px]" data-name="Mistakes">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66 12">
        <g id="Mistakes">
          ...
          <circle cx="42" cy="6" fill="var(--fill-0, #E3E3E3)" id="Ellipse 3" r="6" />
