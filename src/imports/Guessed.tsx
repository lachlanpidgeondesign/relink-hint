import svgPaths from "./svg-57kpmq9tjf";
import { imgGroup } from "./svg-ph7s6";
...
function Tagline() {
  return (
    <div className="content-stretch flex items-center justify-center pt-[12px] px-[16px] relative shrink-0" data-name="TAGLINE">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[15px] text-black text-center">Pick the odd ones out then guess their link!</p>
    </div>
  );
}
...
function LinkContainer() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">TOOLS FOR SCHEDULING</p>
    </div>
  );
}
...
function WordContainer1() {
  return (
    <div className="bg-[#f8cd8b] col-[1/span_3] justify-self-stretch relative rounded-[8px] row-1 self-stretch shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[8px] relative size-full">
          <LinkContainer />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">AGENDA, DIARY, CALENDAR</p>
        </div>
      </div>
    </div>
  );
...
function WordContainer2() {
  return (
    <div className="aspect-[58/58] bg-[#333] col-4 justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#fcfcfc] text-[13px] text-center text-ellipsis">MARK</p>
        </div>
      </div>
...
function LinkContainer1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">WRITING EQUIPMENT</p>
    </div>
  );
}
...
function WordContainer3() {
  return (
    <div className="bg-[#66e0c4] col-[1/span_3] justify-self-stretch relative rounded-[8px] row-1 self-stretch shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[8px] relative size-full">
          <LinkContainer1 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">PAPER, ERASER, PENCIL</p>
        </div>
      </div>
    </div>
  );
...
function WordContainer4() {
  return (
    <div className="aspect-[58/58] bg-[#333] col-4 justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#fcfcfc] text-[13px] text-center text-ellipsis">POINT</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Row1() {
  return (
    <div className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] relative shrink-0 w-full" data-name="Row 2">
      <WordContainer3 />
      <WordContainer4 />
    </div>
  );
...
function LinkContainer2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">TYPES OF LISTS</p>
    </div>
  );
}
...
function WordContainer5() {
  return (
    <div className="bg-[#e583b1] col-[1/span_3] justify-self-stretch relative rounded-[8px] row-1 self-stretch shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[8px] relative size-full">
          <LinkContainer2 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">GROCERY, SHOPPING, GUEST</p>
        </div>
      </div>
    </div>
  );
...
function WordContainer6() {
  return (
    <div className="aspect-[58/58] bg-[#333] col-4 justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#fcfcfc] text-[13px] text-center text-ellipsis">LIST</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function LinkContainer3() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">CHESS PIECES</p>
    </div>
  );
}
...
function WordContainer7() {
  return (
    <div className="bg-[#9aa3ff] col-[1/span_3] justify-self-stretch relative rounded-[8px] row-1 self-stretch shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[8px] relative size-full">
          <LinkContainer3 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#191919] text-[13px] text-center text-ellipsis">KING, BISHOP, KNIGHT</p>
        </div>
      </div>
    </div>
  );
...
function WordContainer8() {
  return (
    <div className="aspect-[58/58] bg-[#333] col-4 justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[#fcfcfc] text-[13px] text-center text-ellipsis">MATE</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function WordContainer() {
  return (
    <div className="max-w-[390px] relative shrink-0 w-full" data-name="Word Container">
      <div className="content-stretch flex flex-col gap-[8px] items-start max-w-[inherit] p-[16px] relative w-full">
        <Grouping />
        <div className="h-0 relative shrink-0 w-full">
          <div className="absolute inset-[-0.5px_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 358 1">
              <path d="M0 0.5H358" id="Vector 5" stroke="var(--stroke-0, #CCCCCC)" />
            </svg>
          </div>
        </div>
        <Grouping1 />
  ...
  return (
    <div className="h-[12px] relative shrink-0 w-[66px]" data-name="Mistakes">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66 12">
        <g id="Mistakes">
          <circle cx="6" cy="6" fill="var(--fill-0, #666666)" id="Ellipse 1" r="6" />
          <circle cx="24" cy="6" fill="var(--fill-0, #666666)" id="Ellipse 2" r="6" />
          <circle cx="42" cy="6" fill="var(--fill-0, #666666)" id="Ellipse 5" r="6" />
          <circle cx="60" cy="6" fill="var(--fill-0, #E3E3E3)" id="Ellipse 4" r="6" />
        </g>
      </svg>
    </div>
  );
...
function Mistakes() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[16px] py-[8px] relative shrink-0" data-name="Mistakes">
      <Mistakes1 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="max-w-[390px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start max-w-[inherit] px-[16px] py-[8px] relative w-full">
        <p className="[text-decoration-skip-ink:none] decoration-solid font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] line-through not-italic relative shrink-0 text-[#191919] text-[15px]">scoring</p>
      </div>
    </div>
  );
}
...
function TextEntry() {
  return (
    <div className="bg-[#fcfcfc] h-[44px] relative rounded-[8px] shrink-0 w-full" data-name="Text Entry">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center pl-[16px] pr-[8px] py-[8px] relative size-full">
...
function PuzzleButton() {
  return (
    <div className="content-stretch flex flex-col h-[38px] items-start opacity-40 pb-[2px] relative shrink-0 w-full" data-name="Puzzle Button">
      <PuzzleButton1 />
    </div>
  );
}
...
function TextEntrySubmitContainer() {
  return (
    <div className="max-w-[390px] relative shrink-0 w-full" data-name="Text Entry + Submit Container">
      <div className="content-stretch flex flex-col gap-[16px] items-start max-w-[inherit] px-[16px] py-[8px] relative w-full">
        <TextEntry />
        <PuzzleButton />
      </div>
    </div>
...
export default function Guessed() {
  return (
    <div className="bg-[#fcfcfc] content-stretch flex flex-col items-center relative size-full" data-name="Guessed">
      <Header />
      <Tagline />
      <WordContainer />
      <Mistakes />
