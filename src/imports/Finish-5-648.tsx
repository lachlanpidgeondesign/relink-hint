import svgPaths from "./svg-57qqivmxhl";
...
function LinkContainer1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Link Container">
      <div className="h-[16px] relative shrink-0 w-0">
        <div className="absolute inset-[0_-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 16">
            <path d="M0.5 16V0" id="Vector 3" stroke="var(--stroke-0, #666666)" />
          </svg>
        </div>
      </div>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#666] text-[13px] text-center text-ellipsis">Guess the link here...</p>
    </div>
  );
}
