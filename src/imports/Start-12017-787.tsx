import svgPaths from "./svg-eznv4f9jmb";
import { imgGroup } from "./svg-ghury";
...
function WordContainer() {
  return (
    <div className="bg-[#00cc9d] h-[58px] relative rounded-[8px] shrink-0 w-full" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-center text-ellipsis text-white">BRITISH</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#007a5e] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4px_0px_0px_#007a5e]" />
    </div>
  );
}
...
function SubmitContainer() {
  return (
    <div className="h-[70px] relative rounded-[8px] shrink-0 w-[88px]" data-name="Submit Container">
      <div className="content-stretch flex flex-col items-center overflow-clip pt-[4px] px-[4px] relative rounded-[inherit] size-full">
        <WordContainer />
      </div>
...
function WordContainer1() {
  return (
    <div className="bg-[#f3ac3d] h-[58px] relative rounded-[8px] shrink-0 w-full" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-center text-ellipsis text-white">AIRWAYS</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#926725] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4px_0px_0px_#926725]" />
    </div>
  );
}
...
function WordContainer2() {
  return (
    <div className="bg-[#5665ff] h-[58px] relative rounded-[8px] shrink-0 w-full" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center pt-[4px] px-[4px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[10px] text-center text-ellipsis text-white">DESTINATIONS</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#343d99] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4px_0px_0px_#343d99]" />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative shrink-0">
      <SubmitContainer />
      <SubmitContainer1 />
      <SubmitContainer2 />
    </div>
...
function Frame1() {
  return (
    <div className="absolute bg-[#fcfcfc] bottom-0 content-stretch flex flex-col items-start justify-center left-0 py-[12px] w-[390px]">
...
function WordContainer3() {
  return (
    <div className="bg-[#f3ac3d] flex-[1_0_0] h-[65px] min-h-px min-w-px relative rounded-[8px]" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-center text-ellipsis text-white">AIRWAYS</p>
        </div>
...
function WordRow() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] h-full items-start justify-center min-h-px min-w-px relative" data-name="Word Row">
      <WordContainer3 />
      <WordContainer4 />
      <WordContainer5 />
    </div>
...
function WordContainer7() {
  return (
    <div className="bg-[#00cc9d] flex-[1_0_0] h-[65px] min-h-px min-w-px relative rounded-[8px]" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-center text-ellipsis text-white">BRITISH</p>
        </div>
...
function WordRow1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] h-full items-start min-h-px min-w-px relative" data-name="Word Row">
      <WordContainer7 />
      <WordContainer8 />
      <WordContainer9 />
    </div>
...
function WordContainer15() {
  return (
    <div className="bg-[#5665ff] flex-[1_0_0] h-[65px] min-h-px min-w-px relative rounded-[8px]" data-name="Word Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] max-h-[22px] not-italic overflow-hidden relative shrink-0 text-[10px] text-center text-ellipsis text-white">DESTINATIONS</p>
        </div>
...
function GameContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-0 px-[16px] py-[12px] size-[390px] top-[44px]" data-name="Game Container">
      <RowContainer />
      <RowContainer1 />
      <RowContainer2 />
      <RowContainer3 />
