import svgPaths from "./svg-wv87dujgnu";
...
function LinkContainer2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Link Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[13px] text-black text-center text-ellipsis">FOOTBALL TEAMS</p>
    </div>
  );
}
...
export default function TextEntered() {
  return (
    <div className="bg-[#fcfcfc] content-stretch flex flex-col items-center relative size-full" data-name="Text entered">
      <Header />
      <WordContainer />
      <ButtonsContainer />
    </div>
